...
public class WrapperClassConvert {
	...
	public Object convertToWrapper(Object input) {
		...
		if (input.getClass() == Integer.class || input.getClass() == Double.class || input.getClass() == Short.class
				|| input.getClass() == Byte.class || input.getClass() == Long.class
				|| input.getClass() == Character.class || input.getClass() == Boolean.class
