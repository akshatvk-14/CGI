...
//		orderFields(queryString);
//		groupFields(queryString);
//		fields(queryString);
//		conditions(queryString);
//		logicalOperators(queryString);
//		aggregates(queryString);
//		
//		return queryParameter;
//	}
//
...
//	 * "from" clause.
//	 */
//	public void fileName(String queryString) {
//		String[] s = queryString.toLowerCase().split(" from ");
//		String fileName[] = s[1].split(" ");
//		queryParameter.fileName = fileName[0];
//	}
//	/*
//	 * 
//	 * Extract the baseQuery from the query.This method is used to extract the
...
//	 */
//	
//	public void baseQuery(String queryString) {
//		String s1[] = queryString.toLowerCase().split(" where ");
//		String s2[] = s1[0].split(" group by ");
//		String ans[] = s2[0].split(" order by ");
//		queryParameter.baseQuery = ans[0];
//	}
//
//	/*
//	 * extract the order by fields from the query string. Please note that we will
...
//	 * "city". Please note that we can have more than one order by fields.
//	 */
//	public void orderFields(String queryString) {
//		String s[] = queryString.toLowerCase().split(" order by ");
//		List<String> list = null;
//		if(s.length == 1) {
//			queryParameter.orderByFields = list;
//			return;
//		}
//		String fields[] = s[1].split(" group by ");
//		String[] arr = fields[0].split(",| and ");
...
//	 * "city". Please note that we can have more than one group by fields.
//	 */
//	public void groupFields(String queryString) {
//		String s[] = queryString.toLowerCase().split(" group by ");
//		List<String> list = null;
//		if(s.length == 1) {
//			queryParameter.groupByFields = list;
//			return;
//		}
//		String fields[] = s[1].split(" order by ");
//		String[] arr = fields[0].split(",| and | or ");
//		list = Arrays.asList(arr);
//		queryParameter.groupByFields = list;
//	}
//	/*
...
//	 * 
//	 */
//	public void conditions(String queryString) {
//		String arr[] = queryString.split(" where ");
//		if(arr.length == 1) {
//			queryParameter.conditions = null;
//			return;
//		}
//		String s[] = arr[1].split(" group by ");
//		String condition[] = s[0].split(" order by ");
//		String ans[] = condition[0].split(",| and | or ");
//		List<Restriction> list = new ArrayList<Restriction>();
...
//			System.out.println(temp[0]);System.out.println(temp[1]);
//			list.add(new Restriction(temp[0],temp[1],op));
//		}
//		queryParameter.conditions = list;
//	}
//	/*
//	 * Extract the logical operators(AND/OR) from the query, if at all it is
//	 * present. For eg: select city,winner,team1,team2,player_of_match from
...
//	 * containing [or,and]
//	 */
//	public void logicalOperators(String queryString) {
//		String s[] = queryString.toLowerCase().split(" where ");
//		if(s.length == 1) {
//			queryParameter.logicalOperators = null;
//			return;
//		}
//		String condition[] = s[1].split(" ");
//		int n = condition.length;
//		List<String> list = new ArrayList<String>();
//		for(int i = 0; i < n; i++) {
//			if(condition[i].equals("and")) {
//				list.add("and");
//			}
//			if(condition[i].equals("or")) {
//				list.add("or");
//			}
//		}
//		queryParameter.logicalOperators = list;
//	}
//	/*
//	 * Extract the aggregate functions from the query. The presence of the aggregate
//	 * functions can determined if we have either "min" or "max" or "sum" or "count"
...
//	 * 
//	 */
//	public void aggregates(String queryString) {
//		String s[] = queryString.toLowerCase().split("select ");
//		String parameter[] = s[1].split(" from ");
//		String agg[] = parameter[0].split(",");
//		int n = agg.length;
//		List<AggregateFunction> list = new ArrayList<AggregateFunction>();
//		for(int i = 0; i < n; i++) {
//			if(agg[i].contains("(")) {
//				String temp[] = agg[i].split("\\(|\\)");
//				list.add(new AggregateFunction(temp[1],temp[0]));
//			}
//		}
//		queryParameter.aggregates = list;
//	}
//}