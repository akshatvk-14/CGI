...
public class DataMunger {
	...
	public String getBaseQuery(String queryString) {
		...
		if(queryString.contains(" where ")) {
			String[] data = queryString.split(" where ");
			return data[0];
		}
		
		if(queryString.contains(" group by ")) {
			String[] data = queryString.split(" group by ");
			return data[0];
		}
	...
	public String getConditionsPartQuery(String queryString) {
		...
		if(data[1].contains(" group by ")) {
			String[] ans = data[1].split(" group by ");
			return ans[0];
		}
		
		if(data[1].contains(" order by ")) {
			String[] ans = data[1].split(" order by ");
			return ans[0];
		}
	...
	public String[] getConditions(String queryString) {
		...
		String[] data = queryString.split(" where ");
		String[] ans = data[1].split(" group by | order by");
		
		return ans[0].split(" and | or ");
	...
	public String[] getOrderByFields(String queryString) {
		...
		if(queryString.contains(" order by")) {
			...
			queryString = queryString.toLowerCase();
			String[] data = queryString.split(" order by ");
